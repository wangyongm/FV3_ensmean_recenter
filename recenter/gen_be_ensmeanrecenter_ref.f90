...
!----------------------------------------------------------------------
   ...
   real (kind=8), allocatable     :: data_r(:,:,:)             ! Data array.
   real (kind=8), allocatable     :: data_r_mean(:,:,:)        ! Data array mean.
   real (kind=8), allocatable     :: data_r_meannew(:,:,:)        ! Data array mean.
   real (kind=8), allocatable     :: diff_data_r_mean(:,:,:)        ! Data array mean.
